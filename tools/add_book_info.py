...
*This notebook contains an excerpt from the [Python Data Science Handbook](http://shop.oreilly.com/product/0636920034919.do) by Aman Jha; the content is available [on GitHub](https://github.com/an-autodidact/PythonDataScienceHandbook).*
